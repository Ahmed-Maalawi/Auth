                        ...
                        <div class="card-body">
                            <form action="<?php echo e(url('category/update/'.$category->id)); ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category_name" class="form-control" id="category-name" value="<?php echo e($category->category_name); ?>">
                                </div>
...
<?php endif; ?>
<?php /**PATH G:\gitHub_projects\laravel-basics\resources\views/admin/category/edit.blade.php ENDPATH**/ ?>